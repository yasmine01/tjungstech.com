...
<head>
    ...
    <title>Dashboard| Tjungstech</title>

    <!-- Bootstrap -->
    <link href="../../style/dash_css/tjungstech-bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="../../style/dash_css/fonts/font-awesome.css" rel="stylesheet">
    <!-- NProgress -->
    ...
    <link href="../../style/dash_css/fonts/font-awesome.min.css" rel="stylesheet">
    <link href="../../style/dash_css/less/glyphicons.less" rel="stylesheet">
</head>
<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-anchor"></i> <span>TjungsTech</span></a>
        </div>
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-edit"></i> Manage <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="?page=device">Device</a></li>
                            <li><a href="?page=dealer">Dealer</a></li>
                            <li><a href="?page=dev_user">Device Owners</a></li>
                        </ul>
                    </li>
                    </li>
