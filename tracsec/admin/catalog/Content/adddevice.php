    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="status_text1"></div>
                ID: <input type="text" id="dev_no" name="dev_no"><span id="txt_no"></span><br><br>
                IMEI: <input type="text" id="dev_imei" name="dev_imei"><span id="txt_imei"></span><br><br>
...
$("#btn_submit").click(function(){
 ...
 // alert(postData);
 var myData={"dev_no":dev_no,"dev_imei":dev_imei};
